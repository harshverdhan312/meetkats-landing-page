...
function App() {
  const handleDownload = () => {
    window.open('https://play.google.com/store/apps/details?id=com.meetkats', '_blank', 'noopener,noreferrer');
  };

  return (
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 selection:bg-primary/30 selection:text-primary relative min-h-screen overflow-x-hidden">
      {/* Navigation */}
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center px-4 py-6">
        <nav className="glass-panel flex items-center justify-between w-full max-w-5xl px-6 py-3 rounded-full border border-white/10">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a className="text-sm font-medium text-slate-400 hover:text-white transition-colors" href="#community">Community</a>
          </div>
